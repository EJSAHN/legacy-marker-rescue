...
2. **Source-data validation.** The source-data workbook contains the derived tables that underlie the display items. `scripts/validate_source_data.py` recomputes headline results from those tables.
