...
`python scripts/validate_source_data.py --workbook data/source/Supplementary_Data_S1.xlsx` recomputes the following manuscript-level quantities from derived source-data tables.
